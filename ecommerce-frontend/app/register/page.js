...
export default function RegisterPage() {
  ...
  return (
    <div className="form-card">
      <h1>Daftar Akun</h1>
      <p className="sub">Buat akun baru untuk mulai belanja di Dumverse Store.</p>
      <form onSubmit={handleSubmit}>
        ...
        <div className="field">
          ...
          <input placeholder="Alamat" value={form.address} onChange={update('address')} />
        </div>
        <div className="field">
          <label>Telepon (opsional)</label>
          <input placeholder="Telepon" value={form.phone} onChange={update('phone')} />
        </div>
